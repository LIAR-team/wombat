...
namespace srrg2_solver {
  ...
  void SE2PosePoseGeodesicErrorFactor::errorAndJacobian(bool error_only_) {
    ...
    // derivative R_error with respect to delta_theta_to (=0)
