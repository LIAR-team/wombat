...
namespace srrg2_core {
  ...
  // 3D benchmark wrapper for: https://www.doc.ic.ac.uk/~ahanda/VaFRIC/iclnuim.html
  ...
  public:
    ...
    void loadDataset(const std::string& filepath_,
      ...
      // set up synchronizer for ICL datasets
    ...
    void loadGroundTruth(const std::string& filepath_,
      ...
      while (ground_truth_file >> timestamp_seconds >> tx >> ty >> tz >> qx >> qy >> qz >> qw) {
        ...
        // fix first timestamp to zero (messages start at zero)
