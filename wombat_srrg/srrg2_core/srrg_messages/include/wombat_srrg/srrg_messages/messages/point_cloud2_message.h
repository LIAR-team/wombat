...
public:
  ...
  void setPointCloud(const Point3fVectorCloud & in_cloud);
  void setPointCloud(const PointIntensity3fVectorCloud & in_cloud);
  ...
  //!                                  implementation)
  void getPointCloud(
    PointIntensity3fVectorCloud& out_cloud_,
