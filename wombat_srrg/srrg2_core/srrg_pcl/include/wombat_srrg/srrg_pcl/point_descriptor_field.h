...
#include "wombat_srrg/srrg_pcl/point_default_field.h"
#include "wombat_srrg/srrg_system_utils/stream_helpers.h"
...
namespace srrg2_core {
  ...
  struct PointDescriptorFieldCvMatBinary {
    ...
    int distance(const PointDescriptorFieldCvMatBinary& other_) const;
  };
  ...
  struct PointDescriptorFieldCvMatFloat {
    ...
    int distance(const PointDescriptorFieldCvMatFloat& other_) const;
  };
  ...
  struct PointDescriptorFieldBit256 {
    ...
    //! similarity distance function for binary descriptors
    int distance(const PointDescriptorFieldBit256& other_) const;
  ...
  struct PointDescriptorFieldFloat32 {
    ...
    //! similarity distance function for floating point descriptors
    int distance(const PointDescriptorFieldFloat32& other_) const;
  };
