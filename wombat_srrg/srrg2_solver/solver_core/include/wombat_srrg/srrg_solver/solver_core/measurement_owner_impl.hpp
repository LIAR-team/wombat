...
#include "wombat_srrg/srrg_solver/solver_core/measurement_owner.h"
...
void MeasurementOwnerEigen_<MeasurementType_>::serializeMeasurement(
  ObjectData& odata,
  IdContext& context)
{
  (void)context;
...
template <typename MeasurementType_>
void MeasurementOwnerEigen_<MeasurementType_>::deserializeMeasurement(
  ObjectData& odata,
  IdContext& context)
{
  (void)context;
