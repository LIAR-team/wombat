...
#include "wombat_srrg/srrg_solver/solver_core/measurement_owner_impl.hpp"
...
// ------------------------------------------------------------------------------------------- //
template <int ErrorDim_, typename... VariableTypes_>
void ErrorFactor_<ErrorDim_, VariableTypes_...>::serialize(
  ObjectData& odata,
  IdContext& context)
{
...
template <int ErrorDim_, typename... VariableTypes_>
void ErrorFactor_<ErrorDim_, VariableTypes_...>::deserialize(
  ObjectData& odata,
  IdContext& context)
{
