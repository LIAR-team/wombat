...
public:
  ...
  /**
    ...
    * @param[in] fixed PointNormal2f from fixed cloud
    */
  inline void setFixed(const FixedType& fixed)
  {
    _fixed_point  = &fixed.coordinates();
    _fixed_normal = &fixed.normal();
  }
  ...
  /**
    ...
    * @param[in] moving PointNormal2f from moving cloud
    */
  inline void setMoving(const MovingType& moving)
  {
    _moving_point  = &moving.coordinates();
    _moving_normal = &moving.normal();
  }
...
public:
  ...
  /**
    ...
    * @param[in] sensor_in_robot Isometry2f sensor pose in robot frame
    */
