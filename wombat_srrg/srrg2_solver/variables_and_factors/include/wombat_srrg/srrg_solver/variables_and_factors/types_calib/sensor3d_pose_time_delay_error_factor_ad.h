...
#include <wombat_srrg/srrg_geometry/ad_quaternion.h>
...
public:
  ...
  /**
    ...
    */
  bool interpolateInData(
    Isometry3adf& interpolated_ad,
  ...
  /**
    ...
    */
  bool getRelativeMeasure(
    Isometry3adf& relative_measure_,
    TimeIsometryMap* data_,
