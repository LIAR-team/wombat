#include "wombat_srrg/srrg_solver/variables_and_factors/types_3d/se3_pose_matchable_error_factor.h"
...
void SE3PoseMatchableEulerLeftErrorFactor::serializeMeasurement(
  ObjectData& odata,
  IdContext& context)
{
  (void)context;
