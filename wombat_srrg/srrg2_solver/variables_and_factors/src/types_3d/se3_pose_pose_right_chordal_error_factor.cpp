#include "wombat_srrg/srrg_solver/variables_and_factors/types_3d/se3_pose_pose_right_chordal_error_factor.h"
...
{
  using JacobianMatrixType_ = Eigen::Matrix<Scalar, 12, 6>;
  ...
  //! Fill Jj
  JacobianMatrixType_ Jj = JacobianMatrixType_::Zero();
