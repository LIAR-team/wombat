#include "wombat_srrg/srrg_solver/variables_and_factors/types_calib/differential_drive_odom_predictor_ad.h"
...
inline void DifferentialDriveOdomPredictorAD::_computeThetaTerms(
  DualValuef& sin_theta_over_theta,
...
const DualValuef DifferentialDriveOdomPredictorAD::cos_coeffs[] = {
  DualValuef(0.),
  DualValuef(0.5),
  DualValuef(0.),
  DualValuef(-1.0 / 24.0),
...
const DualValuef DifferentialDriveOdomPredictorAD::sin_coeffs[] = {
  DualValuef(1.),
  DualValuef(0.),
  DualValuef(-1. / 6.),
  DualValuef(0.),
