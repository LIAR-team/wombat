...
#include <wombat_srrg/srrg_messages_ros/instances.h>
#include <wombat_srrg/srrg_messages_ros/message_handlers/message_rosbag_source.h>
...
int main(int argc, char** argv) {
  ...
  // set up dataset playback from configuration
  ...
  // launch viewer and processing thread (points are not changed at this point)
  ...
  // display viewer until termination signal is received
