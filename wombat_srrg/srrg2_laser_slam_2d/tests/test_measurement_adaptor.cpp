...
TEST_F(Synthetic, MeasurementAdaptor) {
  // allocate an adaptor with default parameters
  ...
  // check computed points
  ASSERT_EQ(points.size(), 100u);

  // TODO validate computed polar positions
}

TEST_F(AIS, MeasurementAdaptorKillianCourt)
{
  // load first message from killian dataset
...
{
  // load first message from intel dataset
