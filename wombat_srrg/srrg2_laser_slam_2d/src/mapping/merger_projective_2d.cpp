#include "wombat_srrg/srrg2_laser_slam_2d/mapping/merger_projective_2d.h"
...
void MergerProjective2D::compute()
{
  ...
  projector->compute(_measurement_matrix, _transformed_measurement.begin(), _transformed_measurement.end());
  ...
  for (; scene_it != _scene_matrix.end() && moving_it != _measurement_matrix.end(); ++scene_it, ++moving_it)
  {
    auto& scell = *scene_it;
