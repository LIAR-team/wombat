...
TEST(MotionModelConstantVelocity3D, UniformTranslation) {
  ...
  for (size_t i = 0; i < 10; ++i) {
    ...
    // motion model should move without error
    ASSERT_LT(error.norm(), std::numeric_limits<float>::min());
