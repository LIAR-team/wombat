...
public:
  ...
  virtual void setCurrentLocalMapId(
    srrg2_solver::VariableBase::Id current_local_map_id)
  {
...
public:
  ...
  /**
    ...
    */
  inline void setCorrespondences(
    const srrg2_core::CorrespondenceVector* correspondences_)
  {
