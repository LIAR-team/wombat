...
public:
  ...
  /**
    ...
    * @param[in] correspondences correspondence vector
    */
  void setCorrespondences(srrg2_core::CorrespondenceVector* correspondences)
  {
  ...
  /**
    ...
    * @param[in] message raw data message ptr
    */
...
public:
  ...
  /**
    ...
    * @param[in] fixed: slice
    */
  void setFixed(FixedType* fixed)
  {
    _fixed              = fixed;
  ...
  /**
    ...
    * @param[in] moving: slice
    */
  void setMoving(MovingType* moving)
  {
    _moving              = moving;
  ...
  /**
    ...
    * @param[in] local_map_in_sensor local map wrt sensor frame
    */
  virtual void setLocalMapInSensor(const EstimateType & local_map_in_sensor)
  {
    _local_map_in_sensor              = local_map_in_sensor;
