...
protected:
  ...
  /**
    ...
    * @param[in] slice_point_cloud_name_: choose the slice you want to check in given local map
    * @param[out] descriptors: set of descriptors for points in local map @ slice_name
    */
  void _retrieveDescriptorsFromLocalMap(
  ...
  /**
    ...
    */
  void _addLoopClosure(
    const EstimateType& pose_in_current_,
...
#include "multi_loop_detector_hbst_impl.hpp"
