...
: public AlignerSliceProcessorBase_<
    typename VariableTypeAt_<
      typename FactorType_::VariableTupleType,0>::VariableType::BaseVariableType>
{
public:
...
protected:
  ...
  void setMovingInFixed(const EstimateType & est) override
  {
    (void)est;
  }
...
#include "aligner_slice_processor_prior_impl.hpp"
