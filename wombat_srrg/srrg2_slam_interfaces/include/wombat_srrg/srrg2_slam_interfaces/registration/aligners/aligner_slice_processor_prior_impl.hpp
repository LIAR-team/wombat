...
void AlignerSliceProcessorPrior_<FactorType_, FixedType_, MovingType_>::bindFixed()
{
  ...
  BaseType::bindSlice(_fixed_slice, BaseType::_fixed_scene, BaseType::param_fixed_slice_name.value());
  if (!_fixed_slice) {
...
void AlignerSliceProcessorPrior_<FactorType_, FixedType_, MovingType_>::bindMoving()
{
  ...
  BaseType::bindSlice(_moving_slice, BaseType::_moving_scene, BaseType::param_moving_slice_name.value());
  if (!_moving_slice) {
