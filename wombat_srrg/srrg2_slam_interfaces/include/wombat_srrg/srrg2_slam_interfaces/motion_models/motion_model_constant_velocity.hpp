...
public:
  ...
  virtual ~MotionModelConstantVelocity() = default;
  ...
  void setRobotInLocalMap(
    const EstimateType & robot_in_local_map,
  ...
  void setRobotInLocalMapPrevious(
    const EstimateType& robot_in_local_map,
    const double timestamp_seconds = 0.0) override
  {
    (void)timestamp_seconds;

    _robot_in_local_map_previous = robot_in_local_map;
  }
